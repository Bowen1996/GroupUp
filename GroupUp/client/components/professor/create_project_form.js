...
/**
* Form that professor fills out to create a project
*/
class CreateProjectForm extends Component {
   ...
   * Populates form if the project already exists
   */
  componentDidMount() {
  ...
  /**
  * Adds a skill to the page state
  * @param e, the event
  */
  addSkill(e) {
    e.preventDefault();
  ...
  /**
   * Removes a skill from the page, real time
  ...
  /**
   * Uploads a CSV file
   * @param e, event that returns the CSV file as the target
   */
  uploadCSV(e) {
  ...
  /**
   * Submits form, updating the database
  ...
  /**
   * If project already exists, allows you to update it.
   */
  updateProject() {
