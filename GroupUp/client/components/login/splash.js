...
export default class Splash extends Component {
  /**
   * Re-directs user to different registration page, depending on
   * if the user is using a professor-supplied link that will sign them
   * up for a class
   */
  createStudentAccount() {
    if (this.props.params.projectId) {
      browserHistory.push('/' + this.props.params.projectId + '/registration/' + 'student');
    } else {
  ...
  /**
   * Re-direct to professor registration
   */
          ...
          <div className="col-md-8 col-sm-12">
            <div className="panel panel-default height-50-percent">
              ...
              <div className="panel-body">
                <UserLogin projectId={this.props.params.projectId} />
              </div>
            </div>
          </div>
